...
final as (
    ...
    select 
        ...
        app_version_code,
        package_name,
        case when app_version_code is null then null else cast( nullif(cast(daily_average_rating as {{ dbt_utils.type_string() }}), 'NA') as {{ dbt_utils.type_float() }} ) end as average_rating,
